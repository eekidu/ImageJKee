...
public class ShapeRoi extends Roi {
	...
	* closest approximation of the original shape's curve segments with line segments.*/
	 ...
	 * {@link Roi#POLYLINE} and {@link Roi#POLYGON} for open and closed shapes, respectively.
	 * Conversion of shapes open and closed with more than MAXPOLY line segments will result,
	 * respectively, in {@link Roi#FREELINE} and {@link Roi#FREEROI} (or
	 * {@link Roi#TRACED_ROI} if {@link #forceTrace} flag is <strong><code>true</code></strong>.
	 */
	 ...
	 * {@link Roi#TRACED_ROI}; else, into a {@link Roi#FREEROI}. */
	 ...
	 * will be of type {@link Roi#ANGLE}.
	 * If <strong><code>true</code></strong> then (sub)path will be parsed into a {@link Roi#ANGLE};
	 * else, into a {@link Roi#POLYLINE}. */
	 ...
	 * value will be of type {@link Roi#POLYLINE} or {@link Roi#POLYGON}; conversion of
	 * shapes with linear segments more than this value will result in Roi objects of type
	 * {@link Roi#FREELINE} or {@link Roi#FREEROI} (see {@link #shapeToRois()}).
	 */
	...
	public Roi[] getRois () {
		...
		if (shape instanceof Rectangle2D.Double) {
			...
			Roi r = new Line((int)((Line2D.Double)shape).getX1(), (int)((Line2D.Double)shape).getY1(), (int)((Line2D.Double)shape).getX2(), (int)((Line2D.Double)shape).getY2());
			rois.addElement(r);
	...
	private Roi createRoi(Vector xCoords, Vector yCoords, int roiType) {
		...
		switch(roiType) {
			...
			case Roi.RECTANGLE:
				...
				break;
			case Roi.LINE: roi = new Line(xPoints[0],yPoints[0],xPoints[1],yPoints[1]); break;
			default:
